...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-npm-check/node_modules/npm-check/lib/in/create-package-summary.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-npm-check/node_modules/npm-check/lib/in/create-package-summary.js</span></h1>
    <h2>
        
        Statements: <span class="metric">88.64% <small>(39 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">76.74% <small>(33 / 43)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-npm-check/node_modules/npm-check/lib/in/</a> &#187; create-package-summary.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isPrivate) {
...
<span class="cstat-no" title="statement not covered" >        const ignoreMatch = Array.isArray(ignore) ? ignore.some(ignoredModule =&gt; <span class="cstat-no" title="statement not covered" >minimatch(moduleName, ignoredModule))</span> : minimatch(moduleName, ignore);</span>
<span class="cstat-no" title="statement not covered" >        if (ignoreMatch) {</span>
<span class="cstat-no" title="statement not covered" >            return false;</span>
        }
    }
&nbsp;
...
&nbsp;
            const latest = installedVersion &amp;&amp; fromRegistry.latest &amp;&amp; fromRegistry.next &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >semver.gt(installedVersion, fromRegistry.latest) </span>? <span class="branch-0 cbranch-no" title="branch not covered" >fromRegistry.next </span>: fromRegistry.latest;
            const versions = fromRegistry.versions || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
...
&nbsp;
            const bump = semver.valid(latest) &amp;&amp;
                        ...
                        (usingNonSemver &amp;&amp; semverDiff(versionToUse, latest) ? <span class="branch-0 cbranch-no" title="branch not covered" >'nonSemver' </span>: semverDiff(versionToUse, latest));
&nbsp;
