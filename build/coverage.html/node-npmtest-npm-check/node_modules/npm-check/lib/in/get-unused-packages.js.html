...
&nbsp;
    return new Promise(resolve =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (skipUnused(currentState)) {
...
&nbsp;
        ...
        const missingFromPackageJson = _.omit(depCheckResults.missing || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span>
